    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          className,
          showFill && (hoverTextColor || "!text-white")
        )}
      ...
      >
        ...
        />
        <span className={cn(
          "relative z-10 inline-flex items-center justify-center gap-2 transition-colors duration-200",
          showFill ? "!text-white" : "!text-black"
        )}>
          {children}
        </span>
      </motion.button>
