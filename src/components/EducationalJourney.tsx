      ...
      <div className="w-full px-6 sm:px-10 lg:px-16 relative z-10 pb-0">
        ...
        {config?.showParentProgress !== false && (
          <motion.div
            ...
            className="w-full max-w-5xl mx-auto mb-8 sm:mb-12 p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-white/95 backdrop-blur-xl border border-gray-200/90 shadow-xl relative z-30"
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6 border-b border-gray-100 pb-3 sm:pb-4">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-tr from-red-500 to-rose-400 flex items-center justify-center text-white shadow-md shadow-red-200 shrink-0">
                  <ShieldCheck className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div>
                  <h4 className="text-base sm:text-xl md:text-2xl font-black text-gray-900 leading-tight">
              ...
              <div className="flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-1.5 rounded-full bg-emerald-50 text-emerald-600 text-xs sm:text-sm font-extrabold border border-emerald-200/80 shadow-xs shrink-0 self-start sm:self-auto">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4 md:gap-5 text-center">
              <div className="p-3 sm:p-5 md:p-6 rounded-2xl bg-gradient-to-b from-red-50/80 via-rose-50/30 to-white border border-red-100 shadow-xs hover:shadow-md transition-all group">
                <div className="flex items-center justify-center text-red-500 mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                  <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div className="text-lg sm:text-2xl md:text-3xl font-black text-gray-900 leading-tight">
                  {config?.parentProgressQuizScore || '96%'}
                </div>
                <div className="text-[10px] sm:text-xs text-gray-600 font-extrabold uppercase tracking-wider mt-1">Quiz Score</div>
              </div>

              <div className="p-3 sm:p-5 md:p-6 rounded-2xl bg-gradient-to-b from-blue-50/80 via-indigo-50/30 to-white border border-blue-100 shadow-xs hover:shadow-md transition-all group">
                <div className="flex items-center justify-center text-blue-500 mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                  <CalendarCheck className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div className="text-lg sm:text-2xl md:text-3xl font-black text-gray-900 leading-tight">
                  {config?.parentProgressAttendance || '98%'}
                </div>
                <div className="text-[10px] sm:text-xs text-gray-600 font-extrabold uppercase tracking-wider mt-1">Attendance</div>
              </div>

              <div className="p-3 sm:p-5 md:p-6 rounded-2xl bg-gradient-to-b from-purple-50/80 via-indigo-50/30 to-white border border-purple-100 shadow-xs hover:shadow-md transition-all group">
                <div className="flex items-center justify-center text-purple-500 mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                  <FileText className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div className="text-lg sm:text-2xl md:text-3xl font-black text-gray-900 leading-tight">
                  {config?.parentProgressRegularTests || 'Weekly'}
                </div>
                <div className="text-[10px] sm:text-xs text-gray-600 font-extrabold uppercase tracking-wider mt-1">Regular Tests</div>
              </div>

              <div className="p-3 sm:p-5 md:p-6 rounded-2xl bg-gradient-to-b from-amber-50/80 via-orange-50/30 to-white border border-amber-100 shadow-xs hover:shadow-md transition-all group">
                <div className="flex items-center justify-center text-amber-500 mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                  <Award className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div className="text-lg sm:text-2xl md:text-3xl font-black text-gray-900 leading-tight">
                  {config?.parentProgressBatchRank || 'Top 5%'}
                </div>
                <div className="text-[10px] sm:text-xs text-gray-600 font-extrabold uppercase tracking-wider mt-1">Batch Rank</div>
              </div>
            </div>
          </motion.div>
        )}
