            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 space-y-6">
              ...
              <div className="pt-6 border-t border-gray-100">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <button
                    type="button"
                    className="p-2.5 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-xl hover:scale-110 transition-all duration-300 cursor-pointer shadow-sm flex items-center justify-center"
                    title="Facebook"
                  >
                    <img
